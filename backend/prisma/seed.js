...
const SUBJECTS_BY_SEMESTER = {
  1: [
    { code: 'CE0101', title: 'Mathematics - I',                  icon: 'functions', cardType: 'pinned-card',   path: '/subject/maths-1',    sortOrder: 1, description: 'Calculus, matrices, and complex numbers' },
    { code: 'CE0102', title: 'Physics',                          icon: 'science', cardType: 'pinned-card', path: '/subject/physics',    sortOrder: 2, description: 'Mechanics, optics, and electromagnetism' },
    { code: 'CE0103', title: 'Basic Electronics',                icon: 'electrical_services', cardType: 'pinned-card', path: '/subject/electronics',sortOrder: 3, description: 'Diodes, transistors, and basic circuits' },
    { code: 'CE0104', title: 'Programming Fundamentals (C)',     icon: 'terminal', cardType: 'pinned-card',   path: '/subject/c-programming', sortOrder: 4, description: 'Fundamentals of C programming' },
    { code: 'CE0105', title: 'Engineering Graphics',             icon: 'architecture', cardType: 'pinned-card', path: '/subject/eng-graphics', sortOrder: 5, description: 'Engineering drawing and CAD basics' },
  ],
  2: [
    { code: 'CE0201', title: 'Mathematics - II',                 icon: 'calculate', cardType: 'pinned-card',   path: '/subject/maths-2',      sortOrder: 1, description: 'Differential equations and transforms' },
    { code: 'CE0202', title: 'Data Structures',                  icon: 'account_tree', cardType: 'pinned-card',   path: '/subject/data-structures', sortOrder: 2, description: 'Arrays, linked lists, trees, graphs' },
    { code: 'CE0203', title: 'Digital Electronics',              icon: 'memory', cardType: 'pinned-card', path: '/subject/digital-electronics', sortOrder: 3, description: 'Logic gates, flip-flops, and combinational circuits' },
    { code: 'CE0204', title: 'Object Oriented Programming (C++)',icon: 'code_blocks', cardType: 'pinned-card', path: '/subject/cpp',          sortOrder: 4, description: 'Classes, inheritance, polymorphism' },
    { code: 'CE0205', title: 'Environmental Science',            icon: 'eco', cardType: 'pinned-card', path: '/subject/env-science',  sortOrder: 5, description: 'Ecology, pollution, and sustainability' },
  ],
  3: [
    { code: 'CE0301', title: 'Discrete Mathematics',             icon: 'join_inner', cardType: 'pinned-card',   path: '/subject/discrete-maths', sortOrder: 1, description: 'Sets, logic, graph theory, combinatorics' },
    { code: 'CE0302', title: 'Computer Organization',            icon: 'developer_board', cardType: 'pinned-card', path: '/subject/computer-org',  sortOrder: 2, description: 'CPU architecture, memory, and I/O' },
    { code: 'CE0303', title: 'Database Management Systems',      icon: 'database', cardType: 'pinned-card',   path: '/subject/dbms',          sortOrder: 3, description: 'SQL, normalization, transactions, and indexing' },
    { code: 'CE0304', title: 'Java Programming',                 icon: 'coffee', cardType: 'pinned-card', path: '/subject/java',          sortOrder: 4, description: 'Core Java, collections, and exception handling' },
    { code: 'CE0305', title: 'Probability & Statistics',         icon: 'query_stats', cardType: 'pinned-card', path: '/subject/probability',   sortOrder: 5, description: 'Probability distributions and statistical inference' },
  ],
  4: [
